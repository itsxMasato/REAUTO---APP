...
namespace REAUTO_APP
{
    public partial class Registrar_Empleado : Form
    {
        ...
        txtIDSolicitante FormSoli = new txtIDSolicitante();
        ...
        private void btnBuscarSolicitante_Click(object sender, EventArgs e)
        {
            ...
            txtDNI.Text = FormSoli.ObtenerSolicitante()[0].ToString();
            txtNombres.Text = FormSoli.ObtenerSolicitante()[1].ToString();
            txtApellidos.Text = FormSoli.ObtenerSolicitante()[2].ToString();
