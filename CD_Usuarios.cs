        ...
        public void CrearUsuarioAdministrador(string usuario, string contraseña)
        {
            ...
            using (SqlConnection conn = dconexion.Conectar())
            {
                ...
                BEGIN
                    ...
                    VALUES 
                        (9, '1601199501234', '14011995045678', 'Miguel', 'Flores', '1995-01-14', 
                         'Jefe de Taller', '2 años como jefe de taller mecánico', 'Español', 
                         'Gestión de equipo, Supervisión de proyectos', 'Activo');
                END";
